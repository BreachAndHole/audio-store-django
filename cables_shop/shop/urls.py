...
urlpatterns = [
    ...
    path('cables/', cache_page(60)(views.AllCablesPageView.as_view()), name='all_cables_page'),
    path('cable/<slug:cable_slug>', cache_page(60)(views.CablePageView.as_view()), name='cable_page'),
